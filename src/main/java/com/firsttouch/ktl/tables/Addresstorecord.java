...
public class Addresstorecord extends TableImpl<AddresstorecordRecord> {
     ...
     */
    @Override
    public Class<AddresstorecordRecord> getRecordType() {
        return AddresstorecordRecord.class;
    }

    /**
     * The column <code>app.addresstorecord.id</code>.
     */
    public final TableField<AddresstorecordRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>app.addresstorecord.addressId</code>.
     */
    public final TableField<AddresstorecordRecord, Integer> ADDRESSID = createField(DSL.name("addressId"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>app.addresstorecord.recordId</code>.
     */
    public final TableField<AddresstorecordRecord, Integer> RECORDID = createField(DSL.name("recordId"), SQLDataType.INTEGER.nullable(false), this, "");

    private Addresstorecord(Name alias, Table<AddresstorecordRecord> aliased) {
        this(alias, aliased, null);
    }

    private Addresstorecord(Name alias, Table<AddresstorecordRecord> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> Addresstorecord(Table<O> child, ForeignKey<O, AddresstorecordRecord> key) {
    ...
    @Override
    public UniqueKey<AddresstorecordRecord> getPrimaryKey() {
        return Keys.KEY_ADDRESSTORECORD_PRIMARY;
    }

    @Override
    public List<ForeignKey<AddresstorecordRecord, ?>> getReferences() {
